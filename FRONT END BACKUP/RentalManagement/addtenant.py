...
bday_label.pack(padx=(0,170))

#Birthday picture para soft edges
bday_pic = Image.open ("Rental Management images/long rectangle.png")
resized = bday_pic.resize((250,35),Image.Resampling.LANCZOS)
bday_pic = ImageTk.PhotoImage(resized)
bday_label = tk.Label(bday_frame, image=bday_pic,borderwidth=0,bg="white")
bday_label.pack(pady=(15,0))

#bday entry
bdayentry_frame = tk.Frame(root, bg="white")
bdayentry_frame.place(x=485,y=310)
bday=tk.Entry(bdayentry_frame,background="#D9D9D9",width=20,borderwidth=0,font=("helvica",13))
bday.pack()


#gender label
gender_frame = tk.Frame(root,height=10,width=500)
gender_frame.place(x=800,y=267)
gender_label=tk.Label(gender_frame,text="Gender",bg='white',font=('times new roman',15,'bold'))
gender_label.pack()

#male label
male_rdbutton=tk.Radiobutton(bg='white')
male_rdbutton.place(x=800,y=310)
#Male label
male_frame = tk.Frame(root,height=10,width=500)
male_frame.place(x=820,y=306)
male_label=tk.Label(male_frame,text="Male",bg='white',font=('times new roman',15,'bold'))
male_label.pack()

#Female label
female_rdbutton=tk.Radiobutton(bg='white')
female_rdbutton.place(x=800,y=350)
#Female label
female_frame = tk.Frame(root,height=10,width=500)
female_frame.place(x=820,y=345)
female_label=tk.Label(female_frame,text="Female",bg='white',font=('times new roman',15,'bold'))
female_label.pack()

#others label
others_rdbutton=tk.Radiobutton(bg='white')
others_rdbutton.place(x=900,y=310)
#others label
others_frame = tk.Frame(root,height=10,width=500)
others_frame.place(x=920,y=306)
others_label=tk.Label(others_frame,text="Others",bg='white',font=('times new roman',15,'bold'))
others_label.pack()

#prefer not to say label
prefer_rdbutton=tk.Radiobutton(bg='white')
prefer_rdbutton.place(x=900,y=350)
#prefer not to say  label
prefer_frame = tk.Frame(root,height=10,width=500)
prefer_frame.place(x=920,y=345)
prefer_label=tk.Label(prefer_frame,text="Prefer Not to Say",bg='white',font=('times new roman',15,'bold'))
prefer_label.pack()
