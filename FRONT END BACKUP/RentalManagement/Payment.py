...
columns = ("Tenant Id", "Name", "Amount","Mode of Payment","Date","Lease Term Start Date","Lease Term End Date")
...
tree.heading("Lease Term Start Date",text="Lease Term Start Date")
tree.heading("Lease Term End Date",text="Lease Term End Date")

# Define the column widths
tree.column("Tenant Id", width=100,anchor='n')
tree.column("Name", width=150,anchor='n')
tree.column("Amount", width=80,anchor='n')
tree.column("Mode of Payment", width=200,anchor='n')
tree.column("Date", width=100,anchor='n')
tree.column("Lease Term Start Date", width=200,anchor='n')
tree.column("Lease Term End Date", width=200,anchor='n')
